...
public class ApplicationTest extends <Application> {
    ...
    public void testEntry() throws JSONException {
        byte secret[] = "Test Secret Value".getBytes();
        String label = "ANKIT: ";
    ...
    public void testEntryURL() throws Exception {
        ...
        try {
            new Entry("otpauth://hotp/ACME%20Co:ankit.das@email.com?secret=HXDMVJECJJWSRB3HWIZR4IFUGFTMXBOZ");
            assertTrue(false);
        }
        catch (Exception e){
        }
        ...
        Entry entry = new Entry("otpauth://totp/ACME%20Co:ankit.das@email.com?secret=HXDMVJECJJWSRB3HWIZR4IFUGFTMXBOZ&issuer=ACME%20Co&ALGORITHM=SHA1&digits=6&period=30");
        assertEquals("ACME Co - ACME Co:ankit.das@email.com", entry.getLabel());
    ...
    public void testEncryptionHelper()
            throws NoSuchPaddingException, BadPaddingException, InvalidKeyException, NoSuchAlgorithmException, IllegalBlockSizeException, UnsupportedEncodingException, InvalidAlgorithmParameterException, DecoderException {
